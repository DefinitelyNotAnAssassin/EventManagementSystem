...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 02, 2024 at 04:32 PM
...
INSERT INTO `audience` (`id`, `name`, `contact`, `email`, `address`, `event_id`, `payment_status`, `attendance_status`, `status`, `date_created`, `user_id`) VALUES
(2, 'George Wilson', '+18456-5455-55', 'gwilson@sample.com', 'Sample', 1, 1, 0, 1, '0000-00-00 00:00:00', NULL),
(6, 'winwin', '123234234', '', '', 1, 0, 0, 0, '2024-06-02 20:53:49', 3);
...
(2, 'Winmari Manzano', 'winmari22', '123123', 3),
(3, 'winwin', 'winwin', '$2y$10$EKDldbKJjLEVcnxth3ZimutAEwM8B8ZOj7Z1RGRumw1vta.x8X3xq', 3);
...
INSERT INTO `venue_booking` (`id`, `name`, `address`, `email`, `contact`, `venue_id`, `duration`, `datetime`, `status`, `user_id`) VALUES
(1, 'John Smith', 'Sample', 'asdasd@gmail.com', '+18456-5455-55', 2, '1 night', '2020-10-14 17:00:00', 1, NULL),
(2, '', '', '', '', 1, '', '0000-00-00 00:00:00', 0, NULL);
